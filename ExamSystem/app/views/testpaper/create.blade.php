    ...
    <div class="container">
        <div ng-controller="createTestPaperController">
            <form class="form-inline">
                <input class="form-control" type="text" placeholder="考试名称">
                <label>开始时间:</label><input class="form-control form_datetime" type="date-time">
                <label>结束时间:</label><input class="form-control form_datetime" type="date-time">
